...
# Final estimate
vec_ard <- dat[["ps"]] * predict(fit_xlearner_d_a0, newdata = dat) + (1 - dat[["ps"]]) * predict(fit_xlearner_d_a1, newdata = dat)
...
Discrimination: *how well can the model distinguish those with low and with high benefit?* <br>
